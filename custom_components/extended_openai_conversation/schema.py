...
Vendored from Home Assistant core
(homeassistant/components/openai_conversation/schema.py, dev branch, 2026-09-22)
so structured output behaves the same as the core OpenAI integration.
"""
